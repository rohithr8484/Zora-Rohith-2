...
import { TrendingUp, Coins, Users, ArrowRight, Zap, Target, Globe } from 'lucide-react';
  ...
  const features = [
    {
      icon: Coins,
      title: 'Create Coins',
      description: 'Launch your own creator coin with Uniswap V4 integration',
      href: '/create'
    },
    {
      icon: TrendingUp,
      title: 'Advanced Trading',
      description: 'Trade with sophisticated V4 features and multi-hop rewards',
      href: '/trade'
    },
    {
      icon: Users,
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              Trade creator coins with advanced Uniswap V4 features. Support your favorite creators 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-300 text-lg max-w-2xl mx-auto">
              Experience next-generation trading with advanced liquidity features and multi-hop rewards
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto">
              Join the revolution of creator-supporter value exchange through innovative trading mechanisms
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/create"
